...
public class CityViewAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("com/example/movieticketapp/Activity/City").addSnapshotListener(new EventListener<QuerySnapshot>() {
    ...
    private void filter(String text) {
        ...
        FirebaseRequest.database.collection("com/example/movieticketapp/Activity/City").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
