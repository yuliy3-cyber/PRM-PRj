...
public class TicketDetailActivity extends AppCompatActivity {
    ...
    void addServiceToLayout(String id){
        FirebaseRequest.database.collection("com/example/movieticketapp/Activity/Ticket").document(id).collection("ServiceInTicket").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for(ServiceInTicket serviceInTicket : listService){
                    ...
                    FirebaseRequest.database.collection("com/example/movieticketapp/Activity/Service").document(serviceInTicket.getServiceID()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
