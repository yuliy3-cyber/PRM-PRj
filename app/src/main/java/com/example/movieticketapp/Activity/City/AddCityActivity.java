...
public class AddCityActivity extends AppCompatActivity {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedCity == null){
                    ...
                    FirebaseRequest.database.collection("com/example/movieticketapp/Activity/City").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        @Override
    ...
    private void CreateDiscountToDatabase() {
        ...
        doc = db.collection("com/example/movieticketapp/Activity/City").document();
