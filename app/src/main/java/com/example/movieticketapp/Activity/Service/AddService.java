...
public class AddService extends AppCompatActivity {
    ...
    private void AddServiceToDatabase() {
        ...
        if (service != null)
            doc = db.collection("com/example/movieticketapp/Activity/Service").document(service.getID());
        else
            doc = db.collection("com/example/movieticketapp/Activity/Service").document();
