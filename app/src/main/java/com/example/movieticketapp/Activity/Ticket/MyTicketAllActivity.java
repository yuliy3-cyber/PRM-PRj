...
//                        a.putExtra("idorder", ((Ticket) o).getIdorder());
    ...
    void loadListTicket(String type) {
        firestore.collection("com/example/movieticketapp/Activity/Ticket").orderBy("time", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
